...
public class UserControllerTest {
	...
	@Test
	public void putUser_whenAuthorizedUserSendUpdateForAnotherUser_receiveForbidden() {
	...
	@Test
	public void putUser_whenAuthorizedUserSendUpdateForAnotherUser_receiveApiError() {
		User user = userService.save(TestUtil.createValidUser("user1"));
		authenticate(user.getUsername());
	...
	public <T> ResponseEntity<T> getUser(String username, Class<T> responseType){
		String path = new StringBuilder(API_1_0_USERS).append("/").append(username).toString();
